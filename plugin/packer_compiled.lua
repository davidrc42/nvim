...
_G.packer_plugins = {
  ["FTerm.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/FTerm.nvim",
    url = "https://github.com/numToStr/FTerm.nvim"
  },
  NeoSolarized = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/NeoSolarized",
  ...
  ["nvim-cheat.sh"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/nvim-cheat.sh",
  ...
  popfix = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/popfix",
  ...
  ["tabline.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/tabline.nvim",
  ...
  ["xresources-nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/xresources-nvim",
